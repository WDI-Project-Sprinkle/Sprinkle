  ...
  render : function() {
    ...
    return (
      ...
      <tr>
        ...
        <td><a className="allButtons" href={this.props.details.indeed_url}>visit Indeed</a></td>
        <td>{this.props.details.career}</td>
        <td><a className="allButtons" href={this.props.details.career_url}>visit Career</a></td>
        <td className="text-center">
        <button onClick={this.handleDelete} href="#" className=" allButtons btn btn-danger btn-xs"><span className="glyphicon glyphicon-remove"></span> Delete
        </button>
        </td>
      </tr>
    )
